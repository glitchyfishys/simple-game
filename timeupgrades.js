...
const upgrades = [
    ...
    },
    {
        ...
        softcap: new BN(1,308),
        reqire: () => progress() > 1 || player.money.time.gt(new BN(1.79,308)),
        reset: () => infinity()
    },
    {
        id:0,
    ...
    },
    {
        ...
        for: ["time","gold","IP"],
        name: "eternity atlis",
        decription: "time gold and IP ^1.25",
        cost: new BN(1,0),
    ...
    },
    {
        ...
        for: "IP",
        name: "b-eternity",
        decription: "challenges stay complete",
        cost: new BN(5,3),
        currencykey: "eternitypoints",
        effect: () => true,
        reqire: () => progress() > 3,
    },
    {
        ...
        for: "IP",
        name: "p-eternity",
        decription: "gain gold per sec and gain 15 max slider value",
        cost: new BN(1,4),
        currencykey: "eternitypoints",
        effect: () => true,
        reqire: () => progress() > 3,
