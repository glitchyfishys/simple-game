...
const challengedata = [
    {
        ...
        for: "gold",
        bordercolor: "blue",
        discription: "time gain is redused by ^0.5: gold ^ 2",
    ...
    },
    {
        ...
        for: "IP",
        bordercolor: "green",
        discription: "gold gain is redused by ^0.5: 1000 times IP",
    ...
    },
    {
        ...
        for: "time",
        bordercolor: "cyan",
        discription: "gold and time gain is redused by ^0.5: time mult by IP",
    ...
    },
    {
        ...
        discription: "gold mults are disabled: IP ^ 3",
    ...
    },
    {
        ...
        for: "time",
        bordercolor: "red",
        discription: "time ^ 1.5 but gold ^0.25: time ^1.25",
    ...
    },
    {
        ...
        for: "gold",
        bordercolor: "lime",
        discription: "time ^ 0.3 but gold ^1.5: gold ^1.25",
    ...
    },
    {
        ...
        for: "IP",
        bordercolor: "#3a46a1",
        discription: "time, gold, IP ^.5 : IP mult by EP",
    ...
    },
    {
        ...
        for: "EP",
        bordercolor: "#c506e4",
        discription: "gold, IP ^0 : EP mult by gold",
    ...
    },
    {
        ...
        for: "IP",
        bordercolor: "#cb0c95",
        discription: "gold, IP ^0.05 : IP mult by gold",
    ...
    },
    {
        ...
        for: "IP",
        bordercolor: "#aadfc6",
        discription: "gold ^0.0333 : unlock a slider for EP",
