...
const upgrades = [
    ...
    },
    {
        ...
        for: "time",
        name: "xv-time",
        decription: "previous ^ 1.3",
        cost: new BN(1,7),
        currencykey: "time",
        effect: () => ups[4].effectordefault().pow(1.3),
        softcap: new BN(1,5),
        reqire: true
    },
    {
    ...
    },
    {
        ...
        reqire: () => player.upgrades.timebits >= 255 || game.progress > 0,
        reset: () => goldify()
    },
    {
        id:0,
    ...
    },
    {
        ...
        cost: [new BN(1,10), new BN(1.8,308)], // the first is gold, second is time
        currencykey: ["gold", "time"],
        effect: () => (BN.div(player.money.time, new BN(1.8,307)).log(10)).mult(IPgain()),
        softcap: new BN(1,308),
        reqire: () => game.progress > 1 || ups[18].brought || player.money.time.gt(new BN(1.79,308)),
        reset: () => infinity()
    },
    {
        id:0,
        ...
        effect: [() => new BN(10), () => new BN(10)], // the first is gold, second is time
        reqire: () => game.progress > 1,
    },
    {
        id:1,
        inid:21,
    ...
    },
    {
        ...
        cap: new BN(1,1e308),
        reqire: () => game.progress > 3 || challenges[6].competed,
        reset: () => eternity(),
    },
    {
        id:0,
    ...
    },
    {
        ...
        cost: new BN(5,2),
        currencykey: "eternitypoints",
        effect: [() => new BN(1.5,0),() => new BN(1.5,0),() => new BN(1.5,0)], // time, gold, IP
        reqire: () => game.progress > 3,
    },
    {
        id:5,
    ...
    },
    {
        ...
        reqire: () => game.progress > 6 || (game.progress > 4 && (player.money.dilatedtime.gte(new BN(1,1000)) || player.challenge.doomed)),
        reset: () => armageddon(),
    },
    {
        id:20,
    ...
    },
    {
        ...
        currencykey: "relics",
        effect: () => true,
        reqire: () => (player.challenge.doomed && player.money.dilatedtime.gte(new BN(1,1000))) || ups[59].brought || Creality[1].complete,
    },
    {
        id:1,
        inid:60,
        ...
        for: "time",
        name: "absolutism",
        decription: "reset for absolutism fragments",
        cost: () => (game.alphabits == 15) ? new BN(1,1.5e10) : (pick[11].brought ? new BN(1, 1e150) : new BN(1,1e300)),
        currencykey: "time",
        effect: () => ASgain(),
        reqire: () => (player.money.time.gte(new BN(1,1e305)) && ups[24].brought && player.end) || game.progress > 6,
        reset: () => absolutism(),
    },
    {
        id:2,
        ...
        for: "DT",
        name: "???",
        decription: "destroy everything you have made",
        cost: new BN(10000),
        currencykey: "absolutismfragments",
        effect: () => true,
        reqire: () => Creality[9].complete && !ups[62].brought,
    },
    {
        id:3,
        inid:62,
        ...
        for: "DT",
        name: "???",
        decription: "destroy the multiverse",
        cost: new BN(10000),
        currencykey: "absolutismfragments",
        effect: () => true,
        reqire: () => Creality[9].complete && !ups[61].brought,
    },
]
